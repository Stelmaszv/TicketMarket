...
class data:
    def set(self,request):
        items={
            ...
            'transports': transport.objects.filter(company__user__username=request.user.username),
            'drivers':driver.objects.filter(company__user__username=request.user.username),
